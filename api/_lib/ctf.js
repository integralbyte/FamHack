...
const CTF_PUBLIC_CHALLENGES = [
  {
    ...
    title: 'Cap Thread',
    mode: 'text',
    prompt: 'Every word below hides one capital letter. Read the capitals in order and combine them into one string.',
    body: 'liFe drAws huMans tHrough Attics. Ciphered brooKs wait.',
    inputLabel: 'Decoded string',
    placeholder: 'Enter the combined string',
  ...
  {
    number: 3,
    title: 'Metadata Multiplication',
    mode: 'text',
    prompt: 'Download the image and inspect the metadata clue. Follow it exactly.',
    body: 'The clue says: "x, then 64 me."',
    assetLabel: 'Download clue image',
    assetUrl: '/assets/ctf/metadata-signal.png',
    inputLabel: 'Encoded answer',
    placeholder: 'Enter the base64 result',
    actionLabel: 'Submit Answer',
  },
  {
    number: 4,
    title: 'Faded Courier',
    mode: 'text',
    prompt: 'The PDF looks blank. It is not. Reveal what is hidden, follow the QR, and tell us the filename you end up downloading.',
    assetLabel: 'Download washed PDF',
    assetUrl: '/assets/ctf/washed-signal.pdf',
    inputLabel: 'Downloaded filename',
  ...
  },
  {
    ...
    body: 'The answer is hidden behind the FamHack logo on the homepage. Base64 it ten times.',
    inputLabel: 'Password',
    placeholder: 'Enter the final encoded string',
    actionLabel: 'Submit Answer',
  },
];
